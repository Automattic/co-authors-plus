...
class CoAuthors_Plus {
	...
	public function action_init(): void {
		 ...
		 *
		 * Feed markup is generated by WordPress core rather than the theme, so unlike
		 * `coauthors_auto_apply_template_tags` this defaults to true. Return false to
		 * leave feed bylines resolving from `post_author`.
		 *
